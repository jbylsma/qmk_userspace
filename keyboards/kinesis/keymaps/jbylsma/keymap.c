...
*
* ,-------------------------------------------------------------------------------------------------------------------.
* | Esc    |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F8  |  F9  |  F10 |  F12 | Mute | VolD | VolU |  F13 | BasLay |
* |--------+------+------+------+------+------+---------------------------+------+------+------+------+------+--------|
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_PG] = LAYOUT(
    ...
    _______,  _______,  _______,  _______,  _______,  TO(_GA),                                                                   _______,  _______,  _______,  _______,  KC_APP,   _______,
