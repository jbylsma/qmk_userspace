...
[_BS] = LAYOUT(
           ...
           KC_LSFT,KC_Z   ,KC_X   ,KC_C   ,KC_V   ,KC_B   ,
                   KC_GRV ,OSL_PG ,KC_LEFT,KC_RGHT,
                                   KC_LCTL,KC_LALT,
                                           KC_LGUI,
                           KC_BSPC,KC_DEL ,KC_PGUP,
           KC_F9  ,KC_F10 ,KC_F11 ,KC_F12 ,VOL_M  ,VOL_D  ,VOL_U  ,KC_NO  ,TO(_BS),
...
[_NP] = LAYOUT(
           ...
           _______,KC_KP_1,KC_KP_2,KC_KP_3,KC_PMNS,_______,
           _______,KC_KP_4,KC_KP_5,KC_KP_6,KC_PPLS,_______,
           _______,KC_KP_7,KC_KP_8,KC_KP_9,KC_PENT,_______,
...
[_MK] = LAYOUT(
           ...
           _______,_______,_______,_______,_______,_______,_______,_______,_______,
           _______,_______,_______,_______,_______,_______,
           _______,KC_BTN1,KC_MS_U,KC_WH_U,_______,_______,
           _______,KC_MS_L,_______,KC_MS_R,_______,_______,
           _______,KC_BTN2,KC_MS_D,KC_WH_D,_______,_______,
                   _______,_______,_______,_______,
                           _______,_______,
                           _______,
                           _______,_______,_______
...
[_PG] = LAYOUT(
           ...
           _______,_______,_______,_______,_______,_______,
           _______,_______,_______,_______,_______,_______,
           TO(_BS),_______,_______,_______,_______,TO(_GA),
           _______,_______,_______,_______,_______,_______,
